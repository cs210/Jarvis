...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, meta = (FriendlyName = "Save World From Game", CompactNodeTitle = "SaveWorld", Keywords = "save world"), Category = Game)
		static FString SaveWorldFromGame(UObject* worldMember);
