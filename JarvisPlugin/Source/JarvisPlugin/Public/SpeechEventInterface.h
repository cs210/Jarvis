...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, meta = (FriendlyName = "SpeechInputCommand", CompactNodeTitle = "", Keywords = "Speech Input Command"), Category = "Speech Input Event")
	void SpeechEventCommand(const FString &UserCommand);
};
